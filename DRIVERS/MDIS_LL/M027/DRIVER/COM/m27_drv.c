 ...
 *
 * $Log: m27_drv.c,v $
 * Revision 1.3  2010/03/10 14:14:55  amorbach
 * R: Porting to MDIS5
 * M: changed according to MDIS Porting Guide 0.8
 *
 * Revision 1.2  2004/05/03 14:36:48  cs
 * M81 id added
 * Minor changes for MDIS4/2004 conformity
 * - changed function prototypes to static (moved here from m27_drv.h)
 * - casts for VC W2k compiler
 *
 * Revision 1.1  1998/12/07 15:59:49  Schmidt
 * Initial Revision
 *
 *---------------------------------------------------------------------------
